...
export const Header = () => {
    ...
    return (
        <div className="flex flex-col w-full top-0 h-[112px] justify-start items-start z-[999] bg-[#02030e]">
            ...
            {/* Navigation Bar */}
            <FadeIn delay={0.2} direction='down' fullWidth zIndex={10} >
                <nav className="flex w-full bg-[#02030e] h-[80px] items-center justify-between px-4 md:px-12 lg:px-24 shadow-[0px_10px_20px_rgba(68,62,116,13%)] z-[999] relative">
                    ...
                    <div className="hidden md:flex items-center justify-center gap-10">
                        <ul className="flex gap-5 text-[#d9d7ec] z-[999]">
                    ...
                    <AnimatePresence>
                        {isMenuOpen && (
                            <motion.div
                                ...
                                exit="exit"
                                variants={menuVariants}
                                className="absolute top-[80px] left-0 w-full bg-[#02030e] z-[1000] md:hidden shadow-lg"
                            >
                                        ...
                                        <AnimatePresence>
                                            {mobileActiveDropdown === 'explore' && (
                                                <motion.ul
                                                    ...
                                                    exit="hidden"
                                                    variants={menuVariants}
                                                    className="w-full text-left mt-2 bg-[#02030e] text-[#d9d7ec]"
                                                >
