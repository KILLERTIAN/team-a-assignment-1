...
export const Hero = () => {
    return (
        <div className="flex flex-col lg:flex-row items-center justify-center min-h-[calc(100vh-112px)] w-full px-5 md:px-10 gap-16 bg-[#02030e]">
            {/* <Image
            ...
            <div className="flex flex-col items-center justify-center w-full p-4 m-4 max-w-[400px] rounded-xl bg-[#6B59ED] h-auto z-[5]">
                ...
                <input
                    ...
                    className="mt-2 w-full max-w-[339px] h-[40px] px-3 py-2 rounded-t-lg rounded-bl-lg bg-[#F7FAFF] text-[#393939] text-[15px] font-[Poppins] font-normal placeholder-gray-500 focus:outline-none"
                />

                <input
                    type="email"
                    placeholder="Email Address"
                    className="mt-4 w-full max-w-[339px] h-[40px] px-3 py-2 rounded-t-lg rounded-bl-lg bg-[#F7FAFF] text-[#393939] text-[15px] font-[Poppins] font-normal placeholder-gray-500 focus:outline-none"
                />
                ...
                <div className="relative w-full max-w-[339px]">
                    <select
                        className="appearance-none mt-2 w-full h-[40px] px-4 py-2 rounded-t-lg rounded-bl-lg bg-[#F7FAFF] text-[#393939] text-[15px] font-[Poppins] font-normal placeholder-gray-500 focus:outline-none"
                        style={{
